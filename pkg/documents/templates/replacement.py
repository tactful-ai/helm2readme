...
def replace_template_parts(template_content, chart_data, requirements_data, chart_folder, ignore_none_description, values_path, sort_values_order):
    """
    ...
    replacement_dict: dict[str | Any, str | Any] = {
        ...
        '{{ template "chart.valuesTable" . }}': get_chart_values_table(chart_folder, ignore_none_description, values_path, sort_values_order),
        '{{ template "chart.valuesSection" . }}': get_chart_values_section(chart_folder, ignore_none_description, values_path, sort_values_order),
