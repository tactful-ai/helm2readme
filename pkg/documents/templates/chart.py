...
def get_helm_docs_version_footer(helm_docs_version):
    version_footer = f"Autogenerated from chart metadata using [helm-docs {helm_docs_version}](https://github.com/norwoodj/helm-docs/releases/v1.11.0)"
